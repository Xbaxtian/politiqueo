<form id="confirmacion">
    <div class="modal fade" id="modalpolitico" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h3>¿Estás seguro de borrar este Político?</h3>
            <input type="hidden" id="idpolitico" name="idpolitico" value="">
          </div>
