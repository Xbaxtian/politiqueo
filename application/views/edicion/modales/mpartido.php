<form id="confirmacion">
    <div class="modal fade" id="modalpartido" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h3>¿Estás seguro de borrar este Partido?</h3>
